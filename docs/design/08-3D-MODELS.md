...
References: referens/fordon-3d.html (all 13 classes, orbit and export),
referens/tiguan-3d.html (one class as a smaller stage).
3D stays in referens. Do not import three.js into product rooms.
