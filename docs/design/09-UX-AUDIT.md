...
| /ekonomi | Book sale | Daily | High (real invoice) | Desk, invoices, statements, vouchers, reports, connections, Revolut room and chart chrome follow `pd_locale`; chart axis text ~6px rendered on mobile (P2) |
