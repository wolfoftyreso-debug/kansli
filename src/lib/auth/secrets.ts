 ...
 */
export function isHardenedRuntime(env: NodeJS.ProcessEnv = process.env): boolean {
...
export function resolveClientSecret(env: NodeJS.ProcessEnv = process.env): string {
